      ...
      {dbLoading ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <button onClick={() => onSelectProject(lastProject.id)}
            style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 16px", background: PURPLE_LIGHT, border: `2px solid ${PURPLE}33`, borderRadius: 10, cursor: "pointer", textAlign: "left" }}>
            <div>
