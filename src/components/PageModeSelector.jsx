...
export default function PageModeSelector({ value, onChange, pageTypes, sites, templateFilter, setTemplateFilter }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", justifyContent: "flex-end" }}>
      ...
      {hasTypes && setTemplateFilter && (
        <div style={{ position: "relative" }}>
          <button
            onClick={() => setShowTypes(v => !v)}
            style={{
              padding: "7px 12px", border: `1.5px solid ${hasActiveFilter ? C.blue : C.border}`,
              borderRadius: 8, cursor: "pointer", fontSize: 12, fontWeight: hasActiveFilter ? 700 : 500,
          ...
          >
            ...
            <span style={{ fontSize: 9, opacity: 0.5 }}>{showTypes ? "▲" : "▼"}</span>
          </button>
          ...
          {showTypes && (
            <div style={{
              ...
              padding: "8px", boxShadow: "0 8px 24px rgba(0,0,0,0.12)", minWidth: 180,
            }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6, paddingBottom: 6, borderBottom: `1px solid ${C.borderLight}` }}>
                <span style={{ fontSize: 11, fontWeight: 600, color: C.textLight }}>Filtrer par type</span>
                {hasActiveFilter && (
                ...
                return (
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                      <div style={{
                        width: 14, height: 14, borderRadius: 3, border: `2px solid ${active ? t.color : C.border}`,
